...
if (role(['permissions' => ['languages' => 'view']])) {
    ...
    if (!empty($data["language_id"])) {
        $columns = [
            'languages.name', 'language_strings.string_id', 'language_strings.string_constant', 'language_strings.string_value'
        ];
        ...
        if ($data["sortby"] === 'name_asc') {
            ...
            $where["ORDER"] = ["language_strings.string_id" => "ASC"];
        }
        ...
        if (isset($strings[0])) {
            ...
            $output['loaded']->title = $strings[0]['name'];
            ...
            foreach ($strings as $string) {
                ...
                $output['content'][$i]->subtitle = strlen($string['string_value']) > 20 ? substr($string['string_value'], 0, 20)."..." : $string['string_value'];
