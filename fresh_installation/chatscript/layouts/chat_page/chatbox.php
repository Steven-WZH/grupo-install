<div class="header">
    ...
    <div class="icons">
        ...
        <span class="toggle_checkbox"><i class="bi bi-list-check"></i></span>
            ...
            <div>
                <div class="search">
                    <div>
                        ...
                        <input type="text" placeholder="<?php echo(Registry::load('strings')->search_here) ?>">
                    </div>
                </div>
                <div class="list">
                    <ul></ul>
...
<div class="search_messages">
    <div>
        <div class="search">
            <div>
                <i class="bi bi-search"></i>
                <input type="text" name="search_messages" placeholder="<?php echo(Registry::load('strings')->search_here) ?>">
            </div>
        </div>
    </div>
</div>
