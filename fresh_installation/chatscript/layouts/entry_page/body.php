                ...
                <div>
                    ...
                    <div class="middle">
                        ...
                        $site_advert = DB::connect()->rand("site_advertisements",
                            ...
                            ["site_advertisements.site_advert_placement" => 'entry_page_form_header', "disabled[!]" => 1, "LIMIT" => 1]
                        );
                        ...
                        $site_advert = DB::connect()->rand("site_advertisements",
                            ['site_advertisements.site_advert_max_height', 'site_advertisements.site_advert_content'],
                            ["site_advertisements.site_advert_placement" => 'entry_page_form_footer', "disabled[!]" => 1, "LIMIT" => 1]
                        );
                        if (isset($site_advert[0])) {
                            $site_advert = $site_advert[0];
                            ?>
